...
namespace SignE::Editor::Application {
    ...
    void EditorLayer::DrawUI() {
        ...
        //             ImGui::InputTextMultiline("##LuaScript", luaScript.code.data(), 1024, ImVec2(-FLT_MIN, ImGui::GetContentRegionAvail().y));
        //         }
        //     }
        // }
        //
        ...
        //     // ImGui::TextColored(imgui_sink->to_imgui_color(msg.level), "[%s] %s", spdlog::level::to_string_view(msg.level), msg.payload.data());
        // }
    ...
    void EditorLayer::DrawScene() {
        Renderer2D::BeginDraw();
        Renderer2D::DrawFPS();
        Renderer2D::DrawRect(0, 0, 100, 100);
